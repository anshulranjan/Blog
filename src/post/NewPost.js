...
class NewPost extends Component{
    ...
    createForm = (title,body, categories) =>
    (
        <form>
                    ...
                    <div className="card-body">
                        ...
                        <div className="form-group">
                            ...
                            <textarea onChange={this.handleChange("body")} type="text" className="form-control" rows="20" value={body}></textarea>
                        </div>
                    ...
                    <button onClick={this.clickSubmit} className = "btn btn-raised btn-primary mt-5 mb-4">Create Post</button>
        </form>
    );
    render(){
        const {title, body, error, loading, user,photo,categories, redirectToProfile} = this.state;
        ...
        return(
            <div className = "container">
                <h1 className="mt-5 mb-5 text-center">Create Blog</h1>
                ...
                {this.createForm(title, body, categories)}
            </div>
        )
    }
}
